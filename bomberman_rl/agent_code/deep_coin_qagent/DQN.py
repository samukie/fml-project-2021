...
class DQNAgent:
    ...
    def create_model(self):
        model = Sequential()
        #-------------------
        model.add(Conv2D(256, (3,3), input_shape=(361,16,len(ACTIONS))))
    ...
    def train(self, terminal_state):
        ...
        current_states = np.array([transition[1]+transition[3] for transition in minibatch])
        print('currst ', current_states.shape)
